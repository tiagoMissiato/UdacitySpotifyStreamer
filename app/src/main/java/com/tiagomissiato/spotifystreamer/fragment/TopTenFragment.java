...
public class TopTenFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mActivity = (TopTenActivity) getActivity();
    ...
    public void populateList(){
        if(tree != null) {
            if(tree.track != null) {
                ArtistTopTrackAdapter adapter = new ArtistTopTrackAdapter(mActivity, tree, treeNodeSize, mActivity);
